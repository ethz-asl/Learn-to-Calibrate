...
class MyKerasModel(TFModelV2):
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config,
        ...
        #input
        self.input = tf.keras.layers.Input(shape=(None,56))
...
def train(config, reporter):
    ...
    while True:
        ...
        if i==0:
            trainer.restore("/home/yunke/ray_results/DDPG_CamImuCalibrEnv_seq_2020-06-03_23-18-37xwsq706i/checkpoint_437/checkpoint-437")
        if i>3:
            checkpoint_path = trainer.save()
