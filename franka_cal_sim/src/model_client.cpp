...
/*
This is the central model client, functions including:
*receive state, action from RL client
*transmit action to the simulation server for trajectory simulation
*receive trajectory length from simulation server
*control recording of bag file of sensors
*transmit current state and action to the estimation server
*receive calibration error and observabiltiy from estimation server
*convert calibration results to reward and new state, transmit back to the RL client
*/
namespace franka_cal_sim
{
    void model_client::onInit()
    {
        ...
        */
        ...
        //sensor bag data recording clients
        ...
        //not used, for intrinsics settings
    ...
    //change ground truth of sensors in real time
    ...
    {
        /*receive state, action from RL client, 
        execute simulation, recording sensor data
        execute calibration
