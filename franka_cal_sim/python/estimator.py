...
def load_camera_intrinsics():
    ...
    mtx[2, 2] = 1
    dist = np.array([ 5.3631031595833795e-02, 5.8546496555231975e-02, -4.6216798555226001e-04, 1.6745292279350978e-03, 0. ])
    return mtx, dist
...
def camera_pose_init(img, objp, mtx, dist):
    ...
    if ret == True:
        ...
        _, rvecs, tvecs, inliers = cv2.solvePnPRansac(objp.reshape(-1, 1, 3), corners2.reshape(-1, 1, 2), mtx, dist)
        return rvecs, tvecs
...
for fname in images:
    ...
    if ret == True:
        ...
        print("found the landmark points (corners) on the measured image data!")
