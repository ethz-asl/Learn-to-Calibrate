...
# This is the main file for model-based RL client for camera intrinsic calibration
...
class ActorCritic:
    ...
    # transition (dynamic) model: generally f(s_t,a_t) = s_{t+1}
    ...
    # reward model: generally g(s_t,a_t) = r_t
...
#memorize previous best particle for initilization
global_opt_1 = []
global_opt_2 = []
global_opt_3 = []
global_opt_4 = []
