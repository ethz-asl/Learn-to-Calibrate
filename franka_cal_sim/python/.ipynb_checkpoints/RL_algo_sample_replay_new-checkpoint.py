...
class ActorCritic:
    ...
    def create_actor_model(self):
        ...
        h2 = Dense(256, activation='relu')(Concatenate()([state_h,state_h_1]))
    ...
    def create_critic_model(self):
        ...
        critic_rnn,state_h2,state_c2 = LSTM(64, return_state=True,kernel_regularizer=tf.keras.regularizers.l2(self.reg_w))(Concatenate()([state_input,act_hist_input]))
        ...
        merged    = Concatenate()([state_h2, state_c2, action_h1])
