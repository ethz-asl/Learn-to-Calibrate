...
class SyncReplayOptimizer(PolicyOptimizer):
    ...
    def save(self):
        f = open("/home/yunke/prl_proj/panda_ws/src/franka_cal_sim/python/replay_buffer.txt", "w")
        for policy_id, replay_buffer in self.replay_buffers.items():
    ...
    def restore(self):
        f = open("/home/yunke/prl_proj/panda_ws/src/franka_cal_sim/python/replay_buffer.txt", "r")
