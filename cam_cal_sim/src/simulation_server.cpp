...
namespace cam_cal_sim
{
	...
	bool simulation_server::model(cam_cal_sim::actionSrv::Request &req,cam_cal_sim::actionSrv::Response &res)
	{
	...
	PLUGINLIB_EXPORT_CLASS(cam_cal_sim::simulation_server, nodelet::Nodelet)
}
