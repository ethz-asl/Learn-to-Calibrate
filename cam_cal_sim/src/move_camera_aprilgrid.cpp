...
//       cur_link_state = get_link_state_srv.response.link_state;
       ...
       //left-right trans
        ...
        for(int i=0;i<T/p;i++)
		{
		   ...
		   //trajectory
		   theta=theta+dtheta;
		   twist.linear.x = cur_link_state.twist.linear.x-cur_link_state.pose.position.x*kp-kd*cur_link_state.twist.linear.x;
		   twist.linear.y = cur_link_state.twist.linear.y-cur_link_state.pose.position.y*kp-kd*cur_link_state.twist.linear.y;
		   twist.linear.z = cur_link_state.twist.linear.z-cur_link_state.pose.position.z*kp-kd*cur_link_state.twist.linear.z;
		   twist.angular.z = 0;
		   twist.angular.x = 0;
		   twist.angular.y = 0;
